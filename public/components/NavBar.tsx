        ...
        <div className="navbar bg-gradient-to-r from-blue-800  to-purple-600 text-white prose prose-2xl max-w-none  malcolm-glow-border-lg malcolm-drop-shadow ">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul
                        ...
                        <li><a className="text-white no-underline">Item 1</a></li>
                        <li>
                            <a>Parent</a>
                            <ul className="p-2">
                                <li><a>Submenu 1</a></li>
            ...
            <div className="navbar-center hidden lg:flex">
                <ul className="menu menu-horizontal px-1">
                    <li><a className="text-white no-underline malcolm-hover-shadow-lg rounded-lg malcolm-glow-border-sm">Vetting Subcontractors</a></li>
                    {/* <li>
                        <details>
